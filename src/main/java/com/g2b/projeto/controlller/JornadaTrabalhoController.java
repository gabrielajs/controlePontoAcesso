...
import com.g2b.projeto.services.JornadaService;
...
public class JornadaTrabalhoController {
    ...
    public ResponseEntity<JornadaTrabalho>  getJornadaByID(@PathVariable("idJornada") Long idJornada) throws Exception {
        return  ResponseEntity.ok(jornadaService.getById(idJornada).orElseThrow(() -> new NoSuchElementException("Pagina não encontrada!")));
